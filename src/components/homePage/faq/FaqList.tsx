...
export default function FaqList() {
  const faqList = [
    ...
    },
    {
      ...
      answer:
        "Так, в цілях безпеки команда і відвідувачі мають залишити простір і перейти в безпечне місце.",
    },
    {
      question: "Чи є у вас власний паркінг?",
      answer:
        "Великий безкоштовний паркінг знаходиться в 3 хвилинах від нас - парковка Епіцентру.",
    },
    {
    ...
    {
      question: "Чи працюєте ви без світла?",
      answer: "Так, в просторі передбачені резервні системи живлення.",
    },
    {
