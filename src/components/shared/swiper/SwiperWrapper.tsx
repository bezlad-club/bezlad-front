...
const controllsVariants = {
  black:
    "bg-black disabled:bg-white disabled:shadow-[0_0_0_1.5px_#000000_inset] text-white disabled:text-black",
  purple:
    "bg-white disabled:bg-purple/40 disabled:border-purple/40 disabled:shadow-[0_0_0_1.5px_#ffffff_inset] text-purple disabled:text-white",
};
      ...
      return (
        <>
          <Swiper
            ...
            className={clsx(overflowVisible ? "overflow-visible!" : "")}
