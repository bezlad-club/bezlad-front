...
/**
 * Секція «Атмосфера, яку хочеться відчути».
 *
 * This interface was referenced by `Config`'s JSON-Schema
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "promoCode".
 */
export interface PromoCode {
  id: number;
  code: string;
  /**
   * Введіть значення від 1 до 100
   */
  discountPercent: number;
  /**
   * Виберіть послуги, до яких застосовується промокод
   */
  applicableServices: (number | Service)[];
  type: 'reusable' | 'personal';
  isActive?: boolean | null;
  validFrom?: string | null;
  validUntil?: string | null;
  /**
   * Залиште пустим для безлімітного
   */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "promoCodeReservation".
 */
export interface PromoCodeReservation {
  id: number;
  promoCode: number | PromoCode;
  status?: ('reserved' | 'confirmed' | 'cancelled' | 'expired') | null;
  reservedAt: string;
  validUntil: string;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "promoCode_select".
 */
export interface PromoCodeSelect<T extends boolean = true> {
  code?: T;
  discountPercent?: T;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "promoCodeReservation_select".
 */
export interface PromoCodeReservationSelect<T extends boolean = true> {
  promoCode?: T;
  status?: T;
  reservedAt?: T;
  validUntil?: T;
